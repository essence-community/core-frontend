...
import {useStyles} from "./FieldPopoverInput.styles";

interface IFieldPopoverInputProps {
    bc: IBuilderConfig;
    disabled?: boolean;
    readOnly?: boolean;
    field: IField;
    store: IFieldPopoverModel;
}

export const FieldPopoverInput: React.FC<IFieldPopoverInputProps> = observer((props) => {
