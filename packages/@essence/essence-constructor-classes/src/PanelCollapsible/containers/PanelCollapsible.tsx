...
import {Grid, Collapse, Typography, useTheme} from "@mui/material";
            ...
            <Grid container direction="column" spacing={layoutTheme === 1 ? 0 : 1}>
                ...
                >
                    <Grid container
                        ...
                        {...GRID_ALIGN_CONFIGS["left-hbox"]}
                    >
                        <Grid className={classes.labelBox}>
                            <Icon
                        ...
                        <Grid className={`${classes.labelBox} ${classes.labelBoxText}`}>
                ...
                <Grid className={classes.collapseContent}>
                    {children
                        ? children
