/*
 * RECORD
 * replace after refactoing:
 * src/models/SettingsModel/SettingsModel.ts - ck_id
...
export const VAR_RECORD_ROUTE_PAGE_ID = "ckPage";
export const VAR_RECORD_ROUTE_VISIBLE_MENU = "clMenu";
