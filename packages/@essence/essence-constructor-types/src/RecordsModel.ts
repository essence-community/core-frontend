...
import type {IBuilderConfig, IBuilderMode, ICkId, IRecord, FieldValue, IRecordsOrder} from "./Builder";
...
export interface IRecordFilter extends Record<string, unknown> {
    datatype?: string;
    format?: string;
    operator: string;
    property: string;
