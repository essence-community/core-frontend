...
|contentwidth|string%|Ширина вложенных полей. Целое число от 1% до 100%. Обязательно добавлять %.|
...
|width|string%|Ширина поля. Целое число от 1% до 100%. Обязательно добавлять %.|
...
|maxsize|Максимальное количество символов|
...
|Наименование|Описание|
|-|:-|
|maxvalue|Максимальное значение. Для значений с дробной частью использовать только точку|
...
|visibleinwindow|Признак отображения в автособираемом окне неактивных полей (анализирует editmode)|
